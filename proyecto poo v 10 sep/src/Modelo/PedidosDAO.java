...
public class PedidosDAO {
    public void guardarPedidos(Pedidos c){
        ...
        documento.put("Metodo de pago",c.getMetodoDePago());
    ...
    //public void obtenerPersonas()
    {
        ...
        {
           p1= new Pedidos((String) cursor.next().get("nombre del cliente"), (String) cursor.curr().get("Descripcion del pedido")
                   , (String) cursor.curr().get("Direccion del cliente"), (String) cursor.curr().get("Metodo de pago"));
